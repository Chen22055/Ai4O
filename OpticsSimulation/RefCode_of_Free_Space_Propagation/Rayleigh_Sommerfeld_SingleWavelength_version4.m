function [U] = Rayleigh_Sommerfeld_SingleWavelength_version4(U0,z,X,Y)
...
pad_U0_1 = round((padrows-size(U0,1)))*2;
pad_U0_2 = round((padcols-size(U0,2)))*2;
pad_h_1 = round((padrows-size(h,1)))*2;
pad_h_2 = round((padcols-size(h,2)))*2;
